...
namespace Code.Enhancements.UnlockConditions.Runtime.Predicates {
    ...
    public class C_DamageReceivedFromSpecificSource : C_DamageDealt {
        ...
        public override void GetVerbose(
            ...
            string current = SC_Utils.FormatNumber(objectsManager.StatsManager.GlobalStats.GetDamageReceived(this.Source));
            ...
            //return $"{indentString}- Receive {goal} {this.Source} damage";

            unlockConditions.Add(
                new C_UnlockCondition {
                    Indent = indent,
                    Text = $"Receive {goal} {this.Source} damage",
