...
namespace Code.Enhancements.UnlockConditions.Editor_.Predicates {
    ...
    public class C_CriticalHitsFromSpecificSourceDealt : C_CriticalHitsDealt {
        ...
        protected override string GetHeader() => "Has dealt X or more critical hits from specific source";
        ...
        public override Runtime.C_Condition TranslateNode() {
            return new Runtime.Predicates.C_CriticalHitsFromSpecificSourceDealt(
