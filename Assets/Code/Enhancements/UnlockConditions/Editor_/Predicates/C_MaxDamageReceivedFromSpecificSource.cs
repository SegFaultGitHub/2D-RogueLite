...
namespace Code.Enhancements.UnlockConditions.Editor_.Predicates {
    ...
    public class C_MaxDamageReceivedFromSpecificSource : C_MaxDamageReceived {
        ...
        protected override string GetHeader() => "Has received X or more damage from specific source  at once";
        ...
        public override Runtime.C_Condition TranslateNode() {
            return new Runtime.Predicates.C_MaxDamageReceivedFromSpecificSource(
