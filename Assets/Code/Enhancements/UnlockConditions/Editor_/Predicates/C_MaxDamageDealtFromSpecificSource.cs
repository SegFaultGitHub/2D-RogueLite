...
namespace Code.Enhancements.UnlockConditions.Editor_.Predicates {
    ...
    public class C_MaxDamageDealtFromSpecificSource : C_MaxDamageDealt {
        ...
        protected override string GetHeader() => "Has dealt X or more damage from specific source at once";
        ...
        public override Runtime.C_Condition TranslateNode() {
            return new Runtime.Predicates.C_MaxDamageDealtFromSpecificSource(
