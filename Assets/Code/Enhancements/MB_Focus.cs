...
namespace Code.Enhancements {
    public class MB_Focus : AMB_Enhancement {
        [Serializable]
        ...
        [SerializeField] private protected Characters.Effects.MB_Focus m_FocusPrefab;
        #endregion

        #region Getters / Setters
        private C_EnhancementData[] Data { get => this.m_Data; }
        private Characters.Effects.MB_Focus FocusPrefab { get => this.m_FocusPrefab; }

        public override E_Enhancement Enhancement { get => E_Enhancement.Focus; }
        #endregion
        ...
        public override void ApplyOnDamageTaken(AMB_Character dealer, AMB_Character receiver, E_DamageSource damageSource, float value) {
            ...
            Characters.Effects.MB_Focus focus = Instantiate(this.FocusPrefab);
            focus.SetSpeedAndMaxStacks(this.GetData().Ratio, this.GetData().MaxStacks);
            receiver.AddEffect(focus, receiver, this.GetData().Duration);
        }
