...
namespace Code.Enhancements {
    public class MB_BrambleArmor : AMB_Enhancement {
        [Serializable]
        ...
        public override E_Enhancement Enhancement { get => E_Enhancement.BrambleArmor; }
        #endregion
        ...
        public override void ApplyOnDamageTaken(AMB_Character dealer, AMB_Character receiver, E_DamageSource damageSource, float value) {
            ...
            dealer.AddEffect(poison, receiver);
        }
