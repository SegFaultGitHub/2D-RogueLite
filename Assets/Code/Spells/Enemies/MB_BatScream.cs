...
namespace Code.Spells.Enemies {
    public class MB_BatScream : AMB_PositionalSpell {
        #region Members
        [Foldout("MB_BatScream", true)]
        ...
        protected override void Start() {
            base.Start();
            this.ObjectsManager.AudioManager.PlayBatScream();
        ...
        public override void TriggerEnter(AMB_Character character) {
            ...
            MB_Confused confused = Instantiate(this.Confused);
            character.AddEffect(confused, this.Character, this.Duration);
        }
