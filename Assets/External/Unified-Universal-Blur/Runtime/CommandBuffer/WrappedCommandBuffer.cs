...
namespace Unified.UniversalBlur.Runtime.CommandBuffer
{
    public readonly struct WrappedCommandBuffer : IWrappedCommandBuffer
    {
        ...
        {
            this._commandBuffer.SetRenderTarget(rt, mipLevel, cubemapFace, depthSlice);
        }
        ...
        {
            this._commandBuffer.DrawProcedural(matrix, material, shaderPass, topology, vertexCount, instanceCount, properties);
        }
    }
}