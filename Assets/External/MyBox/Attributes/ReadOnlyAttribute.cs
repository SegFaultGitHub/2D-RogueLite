...
namespace MyBox {
    public class ReadOnlyAttribute : ConditionalFieldAttribute {
        ...
        public ReadOnlyAttribute(string fieldToCheck, bool inverse = false, params object[] compareValues) : base(
            fieldToCheck,
            inverse,
            compareValues
        ) { }
        ...
        public ReadOnlyAttribute(string[] fieldToCheck, bool[] inverse = null, params object[] compare) : base(
            fieldToCheck,
            inverse,
            compare
        ) { }
...
namespace MyBox.Internal {
    ...
    public class ReadOnlyAttributeDrawer : PropertyDrawer {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            if (!(this.attribute is ReadOnlyAttribute conditional)) return;
