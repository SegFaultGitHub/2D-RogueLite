    ...
    public class CharacterRangeAttributeDrawer : PropertyDrawer {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            if (property.propertyType != SerializedPropertyType.String) {
                ...
                var charactersRange = (CharactersRangeAttribute)this.attribute;
                ...
                if (!warning) {
                    property.stringValue = filteredCharacters.Aggregate(property.stringValue, (p, c) => p.Replace(c.ToString(), ""));
                }
