        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            if (minProp == null || maxProp == null) {
                WarningsPool.LogWarning(
                    "MinMaxRangeAttribute used on <color=brown>"
                    + property.name
            ...
            MinMaxRangeAttribute rangeAttribute = (MinMaxRangeAttribute)this.attribute;
            ...
            float minValue = isInt
                ? minProp.intValue
                : minProp.floatValue;
            float maxValue = isInt
                ? maxProp.intValue
                : maxProp.floatValue;
