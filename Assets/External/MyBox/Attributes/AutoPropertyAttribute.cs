...
namespace MyBox {
    ...
    public class AutoPropertyAttribute : PropertyAttribute {
        ...
        public AutoPropertyAttribute(
            AutoPropertyMode mode = AutoPropertyMode.Children,
            ...
            this.Mode = mode;
            this.PredicateMethodTarget = predicateMethodTarget;
...
namespace MyBox.Internal {
    ...
    public class AutoPropertyDrawer : PropertyDrawer {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            GUI.enabled = this.attribute.As<AutoPropertyAttribute>()?.Editable ?? false;
    ...
    public static class AutoPropertyHandler {
        private static readonly Dictionary<AutoPropertyMode, Func<MyEditor.ObjectField, Func<Object, bool>, Object[]>> ObjectsGetters =
            new Dictionary<AutoPropertyMode, Func<MyEditor.ObjectField, Func<Object, bool>, Object[]>> {
                ...
                [AutoPropertyMode.Parent] = (property, pred) => property.Context.As<Component>()
                    ...
                    .Where(pred)
                    .ToArray(),
                [AutoPropertyMode.Scene] = (property, pred) => MyEditor.GetAllComponentsInSceneOf(
                        property.Context,
        ...
        private static void CheckComponentsInPrefab(GameObject prefab) =>
            MyEditor.GetFieldsWithAttribute<AutoPropertyAttribute>(prefab).ForEach(FillProperty);

        private static void FillProperty(MyEditor.ObjectField property) {
            var apAttribute =
                property.Field.GetCustomAttributes(typeof(AutoPropertyAttribute), true).FirstOrDefault() as AutoPropertyAttribute;
            ...
            var matchedObjects = ObjectsGetters[apAttribute.Mode].Invoke(property, predicateMethod);
