    ...
    public class SearchableEnumDrawer : PropertyDrawer {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            if (this._drawer == null)
                this._drawer = new Internal.SearchableEnumAttributeDrawer();
            GUIContent content = new GUIContent(property.displayName);
            Rect drawerRect = EditorGUILayout.GetControlRect(true, this._drawer.GetPropertyHeight(property, content));
            this._drawer.OnGUI(drawerRect, property, content);
        }
    }
}
...
namespace MyBox.Internal {
    ...
    public class SearchableEnumAttributeDrawer : PropertyDrawer {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            if (this.idHash == 0)
                this.idHash = "SearchableEnumAttributeDrawer".GetHashCode();
            int id = GUIUtility.GetControlID(this.idHash, FocusType.Keyboard, position);
