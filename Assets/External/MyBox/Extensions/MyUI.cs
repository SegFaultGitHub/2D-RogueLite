...
namespace MyBox {
    public static class MyUI {
        ...
        /// </summary>
        public static void SetWidth(this RectTransform transform, float width) => transform.sizeDelta = transform.sizeDelta.SetX(width);

        /// <summary>
        /// Set height of RectTransform with sizeDelta.y
        /// </summary>
        public static void SetHeight(this RectTransform transform, float height) => transform.sizeDelta = transform.sizeDelta.SetY(height);
