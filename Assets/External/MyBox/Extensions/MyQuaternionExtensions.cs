...
namespace MyBox {
    ...
    public static class MyQuaternionExtensions {
        public static Quaternion SetEulerX(this Quaternion quaternion, float x) => Quaternion.Euler(quaternion.eulerAngles.SetX(x));

        public static Quaternion SetEulerY(this Quaternion quaternion, float y) => Quaternion.Euler(quaternion.eulerAngles.SetY(y));

        public static Quaternion SetEulerZ(this Quaternion quaternion, float z) => Quaternion.Euler(quaternion.eulerAngles.SetZ(z));
