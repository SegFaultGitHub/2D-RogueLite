...
namespace MyBox {
    public static class MyExtensions {
        ...
        /// </summary>
        public static Vector3 WorldPointOffsetByDepth(
            this Camera camera,
            Vector3 source,
            ...
            return camera.ScreenToWorldPoint(screenPoint.SetZ(distanceFromCamera), eye);
        }
        ...
        /// </summary>
        public static ComponentOfInterface<T>[] FindObjectsOfInterfaceAsComponents<T>()
            where T : class {
            return Object.FindObjectsOfType<Component>().Where(c => c is T).Select(c => new ComponentOfInterface<T>(c, c as T)).ToArray();
        }
