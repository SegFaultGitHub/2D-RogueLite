...
namespace MyBox {
    ...
    public static class MyMath {
        ...
        /// </summary>
        public static bool InRangeInclusive(this float value, RangedFloat range) => value.InRangeInclusive(range.Min, range.Max);

        /// <summary>
        /// Value is in a RangedInt, max-inclusive.
        /// </summary>
        public static bool InRangeInclusive(this int value, RangedInt range) => value.InRangeInclusive(range.Min, range.Max);
