...
namespace MyBox.EditorTools {
    public static class MyScriptableObject {
        ...
        /// </summary>
        public static T[] LoadAssetsFromResources<T>()
        ...
        /// </summary>
        public static T CreateAsset<T>(string name, string folder = "Assets")
            where T : ScriptableObject {
        ...
        public static T CreateAssetWithFolderDialog<T>(string filename)
            where T : ScriptableObject {
