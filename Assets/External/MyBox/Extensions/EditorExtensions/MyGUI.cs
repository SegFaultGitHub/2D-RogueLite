    ...
    public static class MyGUI {
        ...
        public static GUIStyle BorderlessToolbarButtonStyle {
            get {
                ...
                RectOffset emptyOffset = new RectOffset();
        ...
        public static void Separator() {
            ...
            Vector2 separatorRectPosition = new Vector2(spaceRect.position.x, spaceRect.position.y + spaceRect.height / 2);
            Rect separatorRect = new Rect(separatorRectPosition, new Vector2(spaceRect.width, 1));
        ...
        public static void DrawLine(Color? color = null, bool withSpace = false) {
            ...
            Color lineColor = color ?? EditorStyles.label.normal.textColor.WithAlphaSetTo(0.3f);
        ...
        public static T[] DropArea<T>(string areaLabel, float height, bool allowExternal = false, string externalImportFolder = null)
            where T : Object {
        ...
        /// <param name="externalImportFolder">Path relative to Assets folder</param>
        /// <returns>Received assets. Null if none received</returns>
        public static T[] DropArea<T>(Rect dropArea, string areaLabel, bool allowExternal = false, string externalImportFolder = null)
            where T : Object {
            ...
            return result.Count > 0
                ? result.OrderBy(o => o.name).ToArray()
                : null;
        }
        ...
        public static void SearchablePopup(string[] options, int current, Action<int> onSelectionMade) {
            Rect position = new Rect(Event.current.mousePosition, Vector2.zero);
