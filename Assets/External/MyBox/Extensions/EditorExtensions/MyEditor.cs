...
namespace MyBox.EditorTools {
    ...
    public static class MyEditor {
        ...
        /// </summary>
        public static List<ObjectField> GetFieldsWithAttributeFromScenes<T>()
            where T : Attribute {
        ...
        /// Get all fields with specified attribute on all Unity Objects
        /// </summary>
        public static List<ObjectField> GetFieldsWithAttributeFromAll<T>()
            where T : Attribute {
        ...
        /// </summary>
        public static List<ObjectField> GetFieldsWithAttribute<T>(GameObject root)
            where T : Attribute {
        ...
        /// </summary>
        public static List<ObjectField> GetFieldsWithAttribute<T>(Object[] objects)
            where T : Attribute {
        ...
        /// </summary>
        public static IEnumerable<Component> GetAllComponentsInSceneOf(Object obj, Type type) {
            ...
            if (contextGO.scene.isLoaded)
                return contextGO.scene.GetRootGameObjects().SelectMany(rgo => rgo.GetComponentsInChildren(type, true));
