...
namespace MyBox {
    ...
    public class TransformData {
        ...
        public void Apply(Transform transform) {
            if (this.SavePosition) transform.position = this.Position;
            if (this.SaveRotation) transform.rotation = Quaternion.Euler(this.Rotation);
            if (this.SaveScale) transform.localScale = this.Scale;
        ...
        public static TransformData FromTransform(
            Transform transform,
