...
namespace MyBox.EditorTools {
    ...
    public class DraggableHandler {
        ...
        public static Vector3 DraggableHandle(
            Vector3 position,
            float handleSize,
            Quaternion rotation,
            ...
            switch (Event.current.GetTypeForControl(id)) {
                case EventType.MouseDown:
                    if (HandleUtility.nearestControl == id && validControl) {
                        ...
                        result = leftMouseUsed
                            ? DragHandleResult.LMBPress
                            : DragHandleResult.RMBPress;
                ...
                case EventType.MouseUp:
                    if (GUIUtility.hotControl == id && validControl) {
                        ...
                        result = leftMouseUsed
                            ? DragHandleResult.LMBRelease
                            : DragHandleResult.RMBRelease;
                ...
                case EventType.MouseDrag:
                    if (GUIUtility.hotControl == id && validControl) {
                        ...
                        result = leftMouseUsed
                            ? DragHandleResult.LMBDrag
                            : DragHandleResult.RMBDrag;
