...
namespace MyBox {
    ...
    public class GuidComponent : MonoBehaviour, ISerializationCallbackReceiver {
        public Guid Guid {
            get {
                if (this._guid == Guid.Empty && this.serializedGuid != null && this.serializedGuid.Length == 16)
                    this._guid = new Guid(this.serializedGuid);
                return this._guid;
            }
        }
...
#endif
        public string GuidString => this.Guid.ToString();
        public bool IsGuidAssigned() => this._guid != Guid.Empty;
        ...
        private void CreateGuid() {
            ...
            if (this.serializedGuid == null || this.serializedGuid.Length != 16) {
                ...
                if (this.IsAssetOnDisk()) return;

                Undo.RecordObject(this, "Added GUID");
#endif
                this._guid = Guid.NewGuid();
                this.serializedGuid = this._guid.ToByteArray();
