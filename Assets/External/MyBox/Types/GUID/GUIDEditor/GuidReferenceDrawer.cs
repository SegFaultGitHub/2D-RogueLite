...
namespace MyBox.Internal {
    ...
    public class GuidReferenceDrawer : PropertyDrawer {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            GuidComponent currentGuidComponent = currentGO != null
                ? currentGO.GetComponent<GuidComponent>()
                : null;
            ...
            if (currentGuid != System.Guid.Empty && currentGuidComponent == null) {
                ...
                EditorGUI.LabelField(
                    guidCompPosition,
                    new GUIContent(this.nameProp.stringValue, "Target GameObject is not currently loaded."),
            ...
            if (component != null) {
                this.nameProp.stringValue = component.name;
