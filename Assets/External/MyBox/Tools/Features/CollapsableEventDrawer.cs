...
namespace MyBox.Internal {
    ...
    public class CollapsableEventDrawer : UnityEventDrawer {
        ...
        public CollapsableEventDrawer() {
            this._lists = new Dictionary<State, ReorderableList>();
        }
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label) {
            ReorderableList list = this.GetList(property);
            this._hasPersistentCalls = this.HasPersistentCalls(property);
            if (!this._hasPersistentCalls) {
